...
- [ ] Write component tests
  - [x] UploadForm component (setup created)
  - [ ] ReceiptCard component
  - [ ] ItemsTable component
  - [x] StatusBadge component (test created)
- [ ] Write E2E tests
  - [ ] Upload receipt flow
  - [ ] View receipt list
...
- [ ] Upload receipt → appears in list
- [ ] Click receipt → shows detail page
- [ ] Upload multiple receipts → all appear
- [ ] Processing receipt → status updates automatically
- [ ] Failed upload → error message displayed
- [ ] No receipts → empty state shown
- [ ] Back button → returns to list
- [ ] Mobile camera → captures receipt
...
- [ ] All tests passing (basic test infrastructure in place, needs more tests)
