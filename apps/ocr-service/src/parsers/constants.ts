/**
 * Shared constants for OCR parsing
 ...
 * @param value - The cents portion (match[2] from regex)
 * @returns true if valid (exactly 2 digits)
 */
export function isValidAustrianTotalCents(value: string): boolean {
  return value.length === TOTAL_VALIDATION.CENTS_DIGITS;
}
